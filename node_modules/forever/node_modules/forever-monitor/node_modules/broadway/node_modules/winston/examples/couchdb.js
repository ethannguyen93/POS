...
var logger = new (winston.Logger)({
  transports: [
    ...
    new (winston.transports.Couchdb)({ 'host': '127.0.0.1', 'db': 'logs' })
    // if you need auth do this: new (winston.transports.Couchdb)({ 'user': 'admin', 'pass': 'admin', 'host': '127.0.0.1', 'db': 'logs' })
  ]
});
