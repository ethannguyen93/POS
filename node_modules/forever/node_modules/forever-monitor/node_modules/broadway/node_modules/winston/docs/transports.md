...
* __host:__ (Default: **127.0.0.1**) Remote host of the HTTP logging endpoint
...
* __host:__ (Default **127.0.0.1**) Remote host of the Redis server
...
* __host:__ The host running MongoDB, defaults to 127.0.0.1.
...
* __graylogHost:__ IP address or hostname of the graylog2 server. (default: 127.0.0.1)
