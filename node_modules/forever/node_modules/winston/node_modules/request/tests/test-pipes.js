...
s.listen(s.port, function () {
  ...
  counter++
  var r1 = request.put({url:'http://127.0.0.1:3453/push'}, function () {
    check();
  })
  mydata.pipe(r1)
  ...
  counter++
  var r2 = request.put({url:'http://127.0.0.1:3453/push-json',json:true}, function () {
    check();
  })
  mybodydata.pipe(r2)
  ...
  counter++
  request({url:'http://127.0.0.1:3453/pull'}).pipe(mypulldata)
  ...
  s.on('/catresp', function (req, resp) {
    request.get('http://127.0.0.1:3453/cat').pipe(resp)
  })
  ...
  s.on('/onelineproxy', function (req, resp) {
    var x = request('http://127.0.0.1:3453/doodle')
    req.pipe(x)
    x.pipe(resp)
  })

  counter++
  fs.createReadStream(__filename).pipe(request.put('http://127.0.0.1:3453/pushjs'))

  counter++
  request.get('http://127.0.0.1:3453/cat').pipe(request.put('http://127.0.0.1:3453/cat'))

  counter++
  request.get('http://127.0.0.1:3453/catresp', function (e, resp, body) {
  ...
  counter++
  request.get('http://127.0.0.1:3453/doodle').pipe(doodleWrite)
  ...
  counter++
  request.get({uri:'http://127.0.0.1:3453/onelineproxy', headers:{'x-oneline-proxy':'nope'}}, function (err, resp, body) {
  ...
  counter++
  var afterresp = request.post('http://127.0.0.1:3453/afterresponse').on('response', function () {
  ...
  request.get('http://127.0.0.1:3453/forward1').pipe(validateForward)
  ...
  counter++
  request({url:'http://127.0.0.1:3453/opts'}).pipe(optsStream, { end : false })
})
