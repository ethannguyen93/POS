...
plain_server.listen(plain_server.port, function() {
  ...
  plain_server.on('/to_https', function (req, res) {
    res.writeHead(301, {'location':'https://127.0.0.1:'+https_server.port + '/https'})
    res.end()
  })
  ...
  https_server.listen(https_server.port, function() {
    ...
    https_server.on('/to_plain', function (req, res) {
      res.writeHead(302, {'location':'http://127.0.0.1:'+plain_server.port + '/plain'})
      res.end()
    })
...
function run_tests(httpModules) {
  var to_https = 'http://127.0.0.1:'+plain_server.port+'/to_https'
  var to_plain = 'https://127.0.0.1:'+https_server.port+'/to_plain'
