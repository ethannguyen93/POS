...
module.exports = ScopeManager = (function() {
  function ScopeManager(_arg) {
    this.tags = _arg.tags, this.scopePath = _arg.scopePath, this.usedTags = _arg.usedTags, this.scopeList = _arg.scopeList, this.parser = _arg.parser, this.moduleManager = _arg.moduleManager, this.nullGetter = _arg.nullGetter, this.delimiters = _arg.delimiters;
