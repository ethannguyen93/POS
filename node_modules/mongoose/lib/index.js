 ...
 *     db = mongoose.createConnection('127.0.0.1', 'database', port)
 *
 *     // and options
 *     var opts = { server: { auto_reconnect: false }, user: 'username', pass: 'mypassword' }
 *     db = mongoose.createConnection('127.0.0.1', 'database', port, opts)
 *
 *     // initialize now, connect later
 *     db = mongoose.createConnection();
 *     db.open('127.0.0.1', 'database', port, [opts]);
 *
 ...
 *
 *     // replica sets
 *     var uri = 'mongodb://user:pass@127.0.0.1:port/database,mongodb://anotherhost:port,mongodb://yetanother:port';
