...
exports['short capture'] = function () {
    assert.eql(
        optimist.parse([ '-h', '127.0.0.1' ]),
        { h : '127.0.0.1', _ : [], $0 : expresso }
    );
};

exports['short captures'] = function () {
    assert.eql(
        optimist.parse([ '-h', '127.0.0.1', '-p', '555' ]),
        { h : '127.0.0.1', p : 555, _ : [], $0 : expresso }
    );
};
...
exports['long captures sp'] = function () {
    assert.eql(
        optimist.parse([ '--host', '127.0.0.1', '--port', '555' ]),
        { host : '127.0.0.1', port : 555, _ : [], $0 : expresso }
    );
};
...
exports['mixed short bool and capture'] = function () {
    assert.eql(
        optimist.parse([ '-h', '127.0.0.1', '-fp', '555', 'script.js' ]),
        {
            f : true, p : 555, h : '127.0.0.1',
