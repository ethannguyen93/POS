...
src/mono/monoembedding.exe: export BUILT_PRODUCTS_DIR := ${abs_builddir}
src/mono/monoembedding.exe: export CONFIGURATION := ${BUILDTYPE}
src/mono/monoembedding.exe: export PRODUCT_NAME := build_managed
src/mono/monoembedding.exe: export SDKROOT := /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.11.sdk
src/mono/monoembedding.exe: export SRCROOT := ${abs_srcdir}/
src/mono/monoembedding.exe: export SOURCE_ROOT := ${SRCROOT}
src/mono/monoembedding.exe: export TARGET_BUILD_DIR := ${abs_builddir}
src/mono/monoembedding.exe: export TEMP_DIR := ${TMPDIR}
